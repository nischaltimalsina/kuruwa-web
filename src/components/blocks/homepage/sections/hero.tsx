  ...
  return (
    <section className=''>
      <div className='container relative h-full'>
        ...
        <div className='relative w-full min-h-[80vh] py-24 flex items-center flex-wrap-reverse lg:flex-nowrap justify-center lg:justify-between text-pretty '>
          <div className=' min-w-80'>
            <Image
              src={kuruwaa}
              alt=''
              className='h-full w-full hover:scale-[1.15]  hover:-rotate-6 duration-300 ease-linear'
            />
          </div>
          <div className='flex flex-col items-start justify-center'>
            <p className='text-center lg:text-start max-w-2xl mb-4'></p>
            <h1 className='text-4xl md:text-5xl lg:text-6xl text-center lg:text-start max-w-4xl'>
              <span className='hidden lg:contents text-primary font-accent font-semibold'>
                Kuruwaa:{' '}
              </span>
              Building a Healthier, Happier Future, Together
            </h1>
            <p className='text-center lg:text-start max-w-4xl mt-4 text-base sm:text-xl text-muted-foreground font-light'>
              Find the care you need, when you need it, and experience the peace
              of mind that comes from knowing you have a helping hand.
            </p>
            <div className='w-full flex gap-4 mt-8 items-center justify-center lg:justify-start'>
              <Button
                size={'lg'}
                variant={'outline'}
